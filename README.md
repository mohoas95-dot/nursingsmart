...
مدت قرنطینه بر اساس نوع خطا فرق می‌کند: سهمیهٔ دقیقه‌ای به مقدار `retry-after`
سرویس (یا پیش‌فرض ۳۰ ثانیه)، سقف صریح روزانه ۳۰ دقیقه، کلید باطل ۶ ساعت، و
...
| `AI_KEY_DAILY_QUOTA_COOLDOWN_MS` | `1800000` | قرنطینهٔ سقف صریح روزانه (TPD/RPD) |
